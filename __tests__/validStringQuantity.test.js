import { validStringQuantity } from "../src/validations/function/validStringQuantity.js";

describe("구매할 상품과 수량 형식 확인하는 테스트", () => {
  test("3. 존재하지 않는 상품을 입력하였습니다.", () => {
    const testObjArr = [
      { name: "콜라", quantity: 20 },
    ...
    expect(() => validStringQuantity(testObjArr, testItem)).toThrow(
